...
monster.attacks = {
	...
	{name = "combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -65, maxDamage = -145, range = 7, shootEffect = CONST_ANI_SPEAR, target = true},
	{name = "combat", interval = 3000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -80, maxDamage = -155, range = 7, radius = 3, effect = CONST_ME_BLACKSMOKE, target = false}
}
