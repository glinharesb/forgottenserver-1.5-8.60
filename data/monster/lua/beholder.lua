...
monster.attacks = {
	...
	{name = "combat", type = COMBAT_LIFEDRAIN, interval = 3000, chance = 6, range = 7, minDamage = -35, maxDamage = -45, effect = CONST_ME_MAGIC_RED},
	{name = "combat", type = COMBAT_MANADRAIN, interval = 1000, chance = 5, range = 7, minDamage = -5, maxDamage = -25, effect = CONST_ME_MAGIC_RED}
}
