...
monster.attacks = {
	...
	{name = "combat", type = COMBAT_FIREDAMAGE, interval = 1000, chance = 20, range = 7, minDamage = -30, maxDamage = -75, shootEffect = CONST_ANI_FIRE},
	{name = "firefield", interval = 1000, chance = 13, range = 7, radius = 1, target = true, shootEffect = CONST_ANI_FIRE}
}
