...
monster.attacks = {
	{name = "melee", interval = 2000, chance = 100, skill = 30, attack = 40, condition = {type = CONDITION_POISON, totalDamage = 90, interval = 4000}},
	{name = "combat", type = COMBAT_LIFEDRAIN, interval = 1000, chance = 20, range = 1, minDamage = -60, maxDamage = -100, effect = CONST_ME_MAGIC_RED},
	{name = "combat", type = COMBAT_EARTHDAMAGE, interval = 3000, chance = 17, range = 7, minDamage = -35, maxDamage = -95, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA}
}

monster.defenses = {
	defense = 20,
	armor = 20,
	{name = "combat", type = COMBAT_HEALING, interval = 1000, chance = 25, minDamage = 42, maxDamage = 68, effect = CONST_ME_MAGIC_BLUE}
}
