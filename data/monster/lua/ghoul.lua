...
monster.attacks = {
	...
	{name = "combat", type = COMBAT_LIFEDRAIN, interval = 1000, chance = 12, range = 1, minDamage = -15, maxDamage = -25}
}

monster.defenses = {
	defense = 17,
	armor = 8,
	{name = "combat", type = COMBAT_HEALING, interval = 1000, chance = 13, minDamage = 9, maxDamage = 15, effect = CONST_ME_MAGIC_BLUE}
}
